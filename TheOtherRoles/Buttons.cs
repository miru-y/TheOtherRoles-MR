        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            mediumButton = new CustomButton(
                ...
                () => {
                    ...
                    if (randomNumber == 0) msg = "What is your role? My role is " + RoleInfo.GetRolesString(Medium.target.player, false, false) + name;
                    ...
                    else msg = "What is your killer`s role? My killer is " + RoleInfo.GetRolesString(Medium.target.killerIfExisting, false, false) + name; //exlude mini 
