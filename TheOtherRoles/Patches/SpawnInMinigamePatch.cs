...
namespace TheOtherRoles.Patches
{
    ...
    public class SpawnInMinigamePatch
    {
        ...
        public static void SynchronizeData(SynchronizeTag tag, byte playerId)
        {
            synchronizeData.Synchronize(tag, playerId);
        }
        ...
        public static void Postfix2(SpawnInMinigame __instance)
        {
            // Task Vs Mode
            if (TaskRacer.isValid())
            {
        ...
        {
            if (TaskRacer.isValid()) return true;
        ...
        static float initialDoorCooldown { get { return CustomOptionHolder.airshipInitialDoorCooldown.getFloat(); } }
        static float initialSabotageCooldown { get { return CustomOptionHolder.airshipInitialSabotageCooldown.getFloat(); } }
        static PassiveButton selected = null;
        static List<SpawnCandidate> SpawnCandidates;
        static SynchronizeInfo synchronizeData = new();
        ...
        static void resetSpawnCandidates()
        {
        ...
        static void Synchronize(SynchronizeTag tag, byte playerId)
        {
